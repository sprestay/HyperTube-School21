...
function sortByName(movie_1, movie_2) {
    let i = 0;
    while (movie_1.title.length < i && movie_2.title.length < i &&
    movie_1.title.charCodeAt(i) === movie_2.title.charCodeAt(i))
        i++;
    if (movie_1.title.charCodeAt(i) > movie_2.title.charCodeAt(i))
        return 1;
    else
        return -1;
}

exports.filterScrap = filterScrap;
exports.mapScrap = mapScrap;
